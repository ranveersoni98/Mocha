                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-sidebar px-6 pb-4">
                    <div className="flex align-middle flex-row h-14 items-center border-b-[1px]">
                      ...
                      <Link href="/">
                        <span className="text-3xl ml-2  hover:text-foreground font-bold ">
                          Mocha
                        </span>
                      </Link>
                    </div>
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li className="mt-auto">
                          <a
                            href="#"
                            className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-foreground hover:bg-accent hover:text-foreground"
                          >
                            <Cog6ToothIcon
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 items-center">
              <div className="flex w-full justify-end items-center gap-x-2 lg:gap-x-2 ">
                ...
                <Menu as="div" className="relative">
                  ...
                  >
                    <Menu.Items className="bg-popover border border-border absolute right-0 z-50 w-40 origin-top-right rounded-md shadow-lg focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            onClick={() => {
                            ...
                            className={classNames(
                              active ? "bg-accent" : "",
                              "block px-3 text-left text-sm font-bold h-full p-2 w-full rounded-md text-foreground"
                            )}
                          >
                            {t("logout")}
                          </button>
