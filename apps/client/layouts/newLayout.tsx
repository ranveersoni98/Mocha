                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-background px-6 pb-4">
                    <div className="flex align-middle flex-row h-14 items-center border-b-[1px]">
                      <Link href="/">
                        <span className="text-3xl ml-2 text-foreground  hover:text-foreground font-bold ">
                          Mocha
                        </span>
                      </Link>
                    </div>
                                ...
                                <Link
                                  ...
                                  className={classNames(
                                    item.current
                                      ...
                                      : "hover:bg-secondary dark:hover:bg-secondary-foreground dark:hover:text-foreground ",
          ...
          <div className="sticky top-0 z-10 flex h-14 shrink-0 items-center gap-x-4 border-b bg-background px-4 sm:gap-x-6">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 items-center">
              ...
              <div className="flex w-full justify-end items-center gap-x-2 lg:gap-x-2 ">
                <Button
                  variant="outline"
                  className="relative rounded-md p-2 text-muted-foreground hover:text-muted-foreground hover:cursor-pointer focus:outline-none"
                >
