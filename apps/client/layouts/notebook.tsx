              ...
              <div className="flex-row">
                <nav className="flex-1 w-full " aria-label="Sidebar">
                  <div className="border-b-[1px]">
                    <Link
                      className="inline-flex items-center px-4 py-2 text-sm font-medium text-muted-foreground"
                      href="/notebook/new"
                    >
                      ...
                      <Link
                        ...
                        className={classNames(
                          router.query.id === item.id
                            ...
                            : "text-foreground hover:bg-primary hover:text-primary-foreground hover:bg-opacity-75",
