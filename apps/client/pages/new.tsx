      ...
      <div className="w-full border-b-[1px] p-2 flex flex-row justify-between items-center">
              ...
              <>
                <div className="relative">
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                  >
                    <Listbox.Options className="absolute z-10  max-h-60 w-full overflow-auto rounded-md bg-background py-1 text-base shadow-lg ring-1 ring-border focus:outline-none sm:text-sm">
                      <Listbox.Option
                        className={({ active }) =>
                          classNames(
                            active
              ...
              <>
                <div className="relative">
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                  >
                    <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-background py-1 text-base shadow-lg ring-1 ring-border focus:outline-none sm:text-sm">
                      <Listbox.Option
                        className={({ active }) =>
                          classNames(
                            active
        ...
        <div>
          <button
            ...
            className="rounded bg-primary px-4 py-1.5 text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
          >
            Create Ticket
          </button>
        </div>
