...
function DefaultColumnFilter({ column: { filterValue, setFilter } }) {
  return (
    <input
      className="shadow-sm focus:ring-ring focus:border-ring block w-full sm:text-sm border-border rounded-md bg-background text-foreground"
      type="text"
      value={filterValue || ""}
      onChange={(e) => {
        ...
        <div className="shadow overflow-hidden border-b border-border md:rounded-lg">
          ...
          >
            <div className="hidden sm:block">
              <div className="flex flex-row flex-nowrap w-full space-x-2">
                ...
                <select
                  id="location"
                  name="location"
                  className="block w-full pl-3 pr-10 text-base border-border focus:outline-none focus:ring-ring focus:border-ring sm:text-sm rounded-md bg-background text-foreground"
                  value={pageSize}
                  onChange={(e) => {
            ...
            <div className="flex-1 flex justify-between sm:justify-end">
              <button
                className="relative inline-flex items-center px-4 py-2 border border-border text-sm font-medium rounded-md text-foreground bg-card hover:bg-accent transition-colors"
                type="button"
              ...
              <button
                className="ml-3 relative inline-flex items-center px-4 py-2 border border-border text-sm font-medium rounded-md text-foreground bg-card hover:bg-accent transition-colors"
                type="button"
                onClick={() => nextPage()}
