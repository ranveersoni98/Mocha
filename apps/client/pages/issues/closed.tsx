                      ...
                      <Link href={`/issue/${ticket.id}`}>
                        <div className="flex flex-row w-full bg-background border-b-[1px] p-1.5 justify-between px-6 hover:bg-accent">
                          ...
                          <div className="flex flex-row space-x-3 items-center">
                            ...
                            <div>
                              <span
                                className={`inline-flex items-center rounded-md px-2 py-1 capitalize justify-center w-20 text-xs font-medium ring-1 ring-inset ring-gray-500/10 bg-orange-400 text-primary-foreground`}
                              >
                                {ticket.type}
                              </span>
                            </div>
