    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row, value }) => {
          ...
          return (
            <>
              <span className="inline-flex items-center rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-700 ring-1 ring-inset ring-red-600/10 bg-background">
      ...
      <div className="relative max-w-4xl mx-auto md:px-8 xl:px-0">
        <div className="pt-10 pb-16 divide-y-2">
          <div className="px-4 sm:px-6 md:px-0">
            <h1 className="text-3xl font-extrabold text-foreground">Tickets</h1>
          </div>
          <div className="px-4 sm:px-6 md:px-0">
