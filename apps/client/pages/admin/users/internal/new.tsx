          ...
          <div className="">
            <Flex gap="4" direction="column" align="start">
              <div className="w-1/2">
                ...
                <input
                  type="text"
                  className="px-3 py-2 text-foreground bg-transparent border border-border rounded-md shadow-sm focus:outline-none focus:ring-ring focus:border-ring block w-full sm:text-sm bg-background"
              ...
              <div className="w-1/2 flex flex-col">
                ...
                <select
                  id="language"
                  name="language"
                  className="mt-1 text-foreground bg-transparent block w-full pl-3 pr-10 py-2 text-base border border-border focus:outline-none focus:ring-ring focus:border-ring sm:text-sm rounded-md bg-background"
                  value={language}
              ...
              >
                <button
                  type="button"
                  className="rounded-md bg-primary px-2.5 py-1.5 text-sm font-semibold text-primary-foreground shadow-sm ring-1 ring-inset ring-border hover:bg-primary/90 bg-background"
                >
                  Create User
                </button>
              </div>
