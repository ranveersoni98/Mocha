            ...
            <div className="flex w-full flex-col mt-4 px-1 mb-4">
              {tickets !== undefined && tickets.length === 0 ? (
                <>
                  <button
                    type="button"
                    className="relative block w-full rounded-lg border-2 border-dashed border-border p-12 text-center hover:border-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                    ...
                    <table className="min-w-full divide-y divide-border">
                      ...
                      <tbody className="divide-y divide-border">
                        {tickets !== undefined &&
                            ...
                            >
                              ...
                              <td className="hidden px-3 py-1 text-sm text-muted-foreground sm:table-cell w-[64px]">
                                {item.isComplete === true ? (
                                  ...
                                  <>
                                    <span className="inline-flex items-center gap-x-1.5 rounded-md bg-green-500/10 ring-1 ring-inset ring-green-500/20 px-2 py-1 text-xs text-green-600">
                                      <svg
                          ...
                          >
                            <div>
                              <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-card px-3 py-2 text-sm font-semibold text-foreground shadow-sm ring-1 ring-inset ring-border hover:bg-accent">
                                Options
                                <ChevronDownIcon
                            ...
                            >
                              <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-border rounded-md bg-card shadow-lg ring-1 ring-border focus:outline-none">
                                <div className="py-1">
                                  <Menu.Item>
                                    {({ active }) => (
                                      <a
