                        ...
                        {({ open }) => (
                          <>
                            <div className="relative">
                              <Listbox.Button className="bg-card z-50 relative w-full border border-border rounded-md shadow-sm pl-3 pr-10 px-4 py-1.5 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring sm:text-sm text-foreground">
                              ...
                              <Transition
                                ...
                                leaveTo="opacity-0"
                              >
                                <Listbox.Options className="absolute z-50 mt-1 w-full bg-popover border border-border shadow-lg max-h-60 rounded-md py-1 text-base overflow-auto focus:outline-none sm:text-sm">
                                  {users.map((user: any) => (
                                    <Listbox.Option
                                      key={user.id}
                                      className={({ active }) =>
                  ...
                  <div className="prose max-w-none">
                    <div className="">
                      {data.ticket.fromImap ? (
                        <div className="break-words bg-card rounded-md p-4 text-foreground">
                          <Frame
                            ...
                            <div>
                              <div>
                                ...
                                <textarea
                                  ...
                                  name="comment"
                                  rows={3}
                                  className="block w-full bg-secondary/50 rounded-md border-0 py-1.5 text-foreground shadow-sm ring-1 ring-inset ring-border focus:ring-2 focus:ring-inset focus:ring-ring sm:text-sm sm:leading-6"
                              ...
                              <div className="mt-4 flex items-center justify-end space-x-4">
                                {data.ticket.isComplete ? (
                                  <button
                                    ...
                                    className="inline-flex justify-center items-center gap-x-1.5 rounded-md bg-card px-3 py-1.5 text-sm font-semibold text-foreground shadow-sm ring-1 ring-inset ring-border hover:bg-accent transition-colors"
                                  >
                                    <CheckCircleIcon
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => updateStatus()}
                                    className="inline-flex justify-center gap-x-1.5 rounded-md bg-card px-3 py-1.5 text-sm font-semibold text-foreground shadow-sm ring-1 ring-inset ring-border hover:bg-accent transition-colors"
                                  >
                                    <CheckCircleIcon
                                ...
                                <button
                                  onClick={() => addComment()}
                                  type="submit"
                                  className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-1.5 text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring transition-colors"
                                >
                                  {t("comment")}
                                </button>
                              </div>
