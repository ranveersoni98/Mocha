      ...
      {status === "success" && (
        <div>
          <div className="flex flex-col">
            <div className="py-2 px-6 bg-muted  border-b-[1px] flex flex-row items-center justify-between">
            ...
            {data.tickets.length > 0 ? (
              data.tickets.map((ticket) => {
                ...
                return (
                  <Link href={`/portal/issue/${ticket.id}`}>
                    <div className="flex flex-row w-full bg-background border-b-[1px] p-1.5 justify-between px-6 hover:bg-accent">
                      ...
                      <div className="flex flex-row space-x-3 items-center">
                        ...
                        <div>
                          {ticket.isComplete === true ? (
                            ...
                            <>
                              <span className="inline-flex items-center gap-x-1.5  rounded-md w-20 justify-center font-medium bg-green-500/10 ring-1 ring-inset ring-green-500/20 px-2 py-1 text-xs text-green-600">
                                <svg
              ...
              <div className="min-h-screen flex items-center justify-center">
                <button
                  type="button"
                  className="relative block w-[400px] rounded-lg border-2 border-dashed border-border p-12 text-center hover:border-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                  onClick={() => {
