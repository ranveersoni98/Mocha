...
export default function ClientTicketNew() {
  ...
  return (
    <div className="flex justify-center items-center content-center h-screen bg-background">
      {view === "new" ? (
        <div className="max-w-2xl bg-card p-12 rounded-md">
              ...
              {({ open }) => (
                <>
                  ...
                  <div className="relative mt-2">
                    <Listbox.Button className="relative w-full cursor-default rounded-md bg-card py-1.5 pl-3 pr-10 text-left text-foreground shadow-sm ring-1 ring-inset ring-border focus:outline-none sm:text-sm sm:leading-6">
        ...
        <>
          <div className="rounded-md bg-primary shadow-md p-12">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-4xl font-medium text-primary-foreground">
                  Ticket Submitted
                </h3>
                ...
                {/* <div className="mt-4">
                  <div className="-mx-2 -my-1.5 flex">
                    <Link
                      ...
                      className="rounded-md bg-green-50 px-2 py-1.5 text-sm font-medium text-green-800 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-green-50"
                    >
                      View status
                    </Link>
                  </div>
