  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-primary-foreground bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
      >
        Edit
      </button>
