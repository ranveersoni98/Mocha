  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center px-2.5 py-1.5 border font-semibold border-border shadow-sm text-xs rounded text-foreground bg-card hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
      >
        Reset Password
      </button>
            ...
            >
              <div className="inline-block align-bottom bg-card rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                ...
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  ...
                  <button
                    type="button"
                    className="mt-3 w-full inline-flex justify-center rounded-md border border-border shadow-sm px-4 py-2 bg-card text-base font-medium text-foreground hover:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring sm:mt-0 sm:w-auto sm:text-sm"
                    onClick={() => setOpen(false)}
                  >
                    Cancel
                  </button>
