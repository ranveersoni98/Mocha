          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom bg-card rounded-lg px-4 pt-5 pb-4 text-left shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full sm:p-6">
                <div className="flex flex-row w-full border-b border-border">
                  <span className="text-md pb-2 font-bold">Email Settings</span>

                  <button
                    type="button"
                    className="ml-auto mb-1.5 bg-card text-xs rounded-md text-muted-foreground hover:text-muted-foreground "
                ...
                <div className="space-y-1 mt-4 mb-4">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      name="smtp"
                      id="smtp"
                      className="block w-full rounded-md border-border shadow-sm focus:border-ring focus:ring-ring sm:text-sm"
                      placeholder=""
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      id="reply"
                      className="block w-full rounded-md border-border shadow-sm focus:border-ring focus:ring-ring sm:text-sm"
                      placeholder="noreply@mocha.embrly.ca"
