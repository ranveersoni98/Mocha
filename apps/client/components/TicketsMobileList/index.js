    ...
    <div className="overflow-x-auto md:-mx-6 lg:-mx-8 mt-10">
      <div>
        <input
          ...
          name="text"
          id="text"
          className="shadow-sm focus:border-border focus:ring-border appearance-none block w-full sm:text-sm border-border rounded-md"
          placeholder="Search ...."
          value={f}
          onChange={(e) => filter(e)}
        />
              ...
              <div className="flex justify-start" key={ticket.id}>
                <div className="w-full mb-2 border">
                  <div className="px-4 py-4">
                    <div>
                      <h1 className="font-semibold leading-tight text-2xl text-foreground hover:text-foreground ml-1">
                        {ticket.title}
                      </h1>
                      <p className="px-2">
                    ...
                    <div className="text-foreground text-sm font-bold mt-2">
