    ...
    <div>
      <div className="">
        <button
          ...
          className={
            show === "main"
              ? "inline-flex float-right -mt-8 items-center px-3 py-2 border border-border shadow-sm text-sm leading-4 font-medium rounded-md text-foreground bg-card hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
              : "hidden"
          }
        >
          Add Webhook
            ...
            {data.hooks.length > 0 ? (
              <div>
                {data.hooks.map((hook) => (
                  <div
                    key={hook.id}
                    className="rounded-lg border border-border bg-card px-6 py-5 shadow-sm flex items-center space-x-3"
                  >
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-primary-foreground bg-destructive hover:bg-destructive/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
                      >
                        Delete
                      </button>
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div className="mt-1">
                <input
                  ...
                  name="url"
                  id="url"
                  className="shadow-sm focus:ring-green\-500 focus:border-ring block w-full sm:w-1/2 md:w-3/4 sm:text-sm border-border rounded-md"
                  required
              ...
              <div className="mt-1">
                <input
                  ...
                  name="url"
                  id="url"
                  className="shadow-sm focus:ring-ring focus:border-ring block w-full sm:w-1/2 md:w-3/4 sm:text-sm border-border rounded-md"
                  placeholder=""
