      ...
      >
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-muted bg-opacity-25 transition-opacity" />
          </Transition.Child>
          ...
          <div className="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
            ...
            >
              <Dialog.Panel className="mx-auto max-w-2xl transform divide-y divide-border overflow-hidden rounded-xl bg-card shadow-2xl transition-all border border-border">
                <Combobox>
                  <div className="relative">
                    ...
                    />
                    <Combobox.Input
                      className="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-foreground placeholder:text-muted-foreground focus:ring-0 sm:text-sm"
                  ...
                  {(query === "" || tickets.length > 0) && (
                    <Combobox.Options
                      static
                      className="max-h-80 scroll-py-2 divide-y divide-border overflow-y-auto"
                    >
                      {/* <li className="p-2">
                        {query === "" && (
                          ...
                          <Combobox.Option
                            ...
                            className={({ active }) =>
                              classNames(
                                ...
                                active &&
                                  "bg-accent text-accent-foreground hover:cursor-pointer"
                              )
                            }
                          >
                            {({ active }) => (
